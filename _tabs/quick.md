...
This document is an abbreviated quick setup guide. See the full setup instructions at
[https://online.neoman.dev/setup](https://online.neoman.dev/setup).
...
To configure an Avatar to track proceed to the next section.
...
See below to configure your Discord Webhook URL.
...
To setup a Discord Channel with Online Tracker notifications, see https://online.neoman.dev/discord/

## Additional Configuration

Many more configuration options are described at https://online.neoman.dev/configuration/
